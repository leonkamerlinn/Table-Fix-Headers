...
public class SimpleTable extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		final MatrixTableAdapter<String> matrixTableAdapter = new MatrixTableAdapter<>(this, new String[][] {
						{ "Row&Column -1", "Column 0", "Column 1", "Column 2", "Column 3", "Column 4" },
						{ "Row 0", "sed", "do", "eiusmod", "tempor", "incididunt" },
						{ "Row 1", "irure", "occaecat", "enim", "laborum", "reprehenderit" },
						{ "Row 2", "fugiat", "nulla", "reprehenderit", "laborum", "consequat" },
						{ "Row 3", "consequat", "laborum", "fugiat", "eiusmod", "enim" },
						{ "Row 4", "nulla", "Excepteur", "voluptate", "occaecat", "et" },
						{ "Row 5", "occaecat", "fugiat", "dolore", "consequat", "eiusmod" },
						{ "Row 6", "fugiat", "Excepteur", "occaecat", "fugiat", "laborum" },
						{ "Row 7", "voluptate", "reprehenderit", "Excepteur", "fugiat", "nulla" }, });
